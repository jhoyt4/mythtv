...
# Additionally, only the virtual environment's contents are necessary when one
# is used
...
execute_process(
  ...
  COMMAND ${CMAKE_COMMAND} -E create_symlink "../Python" "${PYTHON_FMWK_LIB_DIR}/libpython${PYTHON_BASENAME}.dylib"
  ...
  COMMAND ${CMAKE_COMMAND} -E create_symlink "../../../../Frameworks/Python.framework/Versions/${PYTHON_DOT_VERSION}/Python" "${PYTHON_RSRC_LIB_DIR}/config-${PYTHON_DOT_VERSION}-darwin/libpython${PYTHON_BASENAME}.a"
  COMMAND ${CMAKE_COMMAND} -E create_symlink "../../../../Frameworks/Python.framework/Versions/${PYTHON_DOT_VERSION}/Python" "${PYTHON_RSRC_LIB_DIR}/config-${PYTHON_DOT_VERSION}-darwin/libpython${PYTHON_BASENAME}.dylib")
